...
public class FriendVeiwer {
	...
	private JPanel FollowersListPanel;
	...
	private MyCellRenderer ListWrapper;
	...
	private void TimelineTabInit() throws TwitterException {
		...
		for (Status status : statuses) {
			model.addElement(html1 + "400" + html2 + engine.getRealName() + ": " + status.getText() + "\n");
			model.addElement(" ");
